	...
	<table id="list">
		...
		<tr><th>상품명</th><td width="343" colspan="5">
	  	...
	  	<tr><th>원가[A]</th><td width="70">
	  			<input type="text" name="price" size="11" value="${productVO.price}"></td>
	  			<th>판매가[B]</th><td width="70">
				<input type="text" name="price2" size="11" value="${productVO.price2}"></td>
		    	<th>[B-A]</th><td width="72">
		    		<input type="text" name="price3" size="11" value="${productVO.price2-productVO.price}">
		    	</td></tr>
		 <tr><th>베스트상품</th>
		 	<td><c:choose>
		 ...
		 <tr><th>상세설명</th><td colspan="5">	<textarea name="content" rows="8"
		 		cols="70" ><pre>${productVO.content}</pre></textarea></td></tr>
