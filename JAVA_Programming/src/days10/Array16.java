...
public class Array16 {
	...
	public static void main(String[] args) {
		...
		for(int k : b) System.out.printf("%d ", k);
		System.out.println();
		// 레퍼런스 변수 간 값의 복사로는 배열의 복사까지 이루어지지 않습니다
		// 위의 동작 b=a; 는 a가 갖고 있는 참조값(주소)를 b변수에 복사한 것이므로
		// 배열공간은 하나, 그 배열 주소를 저장한 변수는 두 개로 설정한 것과 같습니다
		// 따라서 a[2]값 변경은 b[2]값 변경과 같습니다
		
		// 1. 배열복사 방법 1번 : 새로운 공간을 new로 만들고 각 요소를 일일이 복사
		b = new int[5];
		...
		// 2차원 배열의 복사
		// 2차원배열(다차원배열)은 clone메소드의 결과로 실제 1차원배열을 관리하고 있는
		// 참조변수의 배열만 복사합니다. (2차원 배열의 전체적 행갯수만 복사한다는 뜻)
		...
		arr5[0] = new int[3];
		arr5[1] = new int[3];
		// 새로 공간 생성 후 각각 값을 다시 복사해야 완벽한 복사가 실행됩니다
