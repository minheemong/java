...
// 다만, 컬렉션 클래스의 입력, 반환에 관련한 모든 메소드는 Object타입을 기반으로 하기 때문에
...
// a.add(100);
// Integer i = (Integer)a.get(0); // 다시 꺼내 쓸 때 강제 형변환이 반드시 필요
// 제네릭 문법------------------------------------------------------------------
// 동일한 이름의 클래스이지만
// 객체 생성 시점에... 자료형을 지정하여 서로 다른 자료형을 지원하는 클래스를 생성할 수 있는 문법
// (메소드 오버로딩과 유사한 문법)

// 제네릭 문법을 사용한 Array List 클래스의 객체 생성 예시
// ArrayList<Integer> a = new ArrayList<Integet>();
...
public class Collection03 {
	...
	public static void main(String[] args) {
		...
		// 제네릭 타입이 지정된 컬렉션 객체의 Object 타입을 받는 메소드는
